 ...
 */
! function (t, e) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).mdui = e()
}(this, function () {
  "use strict";
  ...
  function n(n) {
    ...
    function t(t, e) {
      ...
      return n.initMouseEvent(t, e.bubbles, e.cancelable, window, 0, e.screenX || 0, e.screenY || 0, e.clientX || 0, e.clientY || 0, e.ctrlKey || !1, e.altKey || !1, e.shiftKey || !1, e.metaKey || !1, e.button || 0, e.relatedTarget || null), n
    }
  ...
  function r(n, i) {
    ...
    0 !== n._state ? (n._handled = !0, s._immediateFn(function () {
  ...
  }, s.prototype.finally = e, s.all = function (e) {
  ...
  }, s.allSettled = n, s.resolve = function (e) {
  ...
  "function" != typeof f.Promise ? f.Promise = s : f.Promise.prototype.finally ? f.Promise.allSettled || (f.Promise.allSettled = n) : f.Promise.prototype.finally = e;
  var A = ["animationIterationCount", "columnCount", "fillOpacity", "flexGrow", "flexShrink", "fontWeight", "gridArea", "gridColumn", "gridColumnEnd", "gridColumnStart", "gridRow", "gridRowEnd", "gridRowStart", "lineHeight", "opacity", "order", "orphans", "widows", "zIndex", "zoom"];
  ...
  function R(t) {
    var n = this;
    return this.length = 0, t && (D(t, function (t, e) {
      n[t] = e
    }), this.length = t.length), this
  }
  var H, L = ((H = function (t) {
    if (!t) return new R;
    if (t instanceof R) return t;
    if (p(t)) return /complete|loaded|interactive/.test(document.readyState) && document.body ? t.call(document, H) : document.addEventListener("DOMContentLoaded", function () {
    ...
    if (E(t)) {
      ...
      if (!("#" === t[0] && !t.match(/[ .<>:~]/))) return new R(document.querySelectorAll(t));
  ...
  function U(s, t, r, a) {
    ...
    t ? t.split(" ").forEach(function (t) {
      var e, n, i, o;
      t && (e = s, n = r, i = a, o = W(t), (z[q(e)] || []).filter(function (t) {
        return t && (!o.type || t.type === o.type) && (!o.ns || Y(o.ns).test(t.ns)) && (!n || q(t.func) === q(n)) && (!i || t.selector === i)
      })).forEach(function (t) {
        return u(t)
      })
  ...
  function X(n, t) {
    for (var e = [], i = arguments.length - 2; 0 < i--;) e[i] = arguments[i + 2];
    return e.unshift(t), D(e, function (t, e) {
      D(e, function (t, e) {
        O(e) || (n[t] = e)
      })
    }), n
  ...
  function V(t) {
    ...
    function s(n, i) {
      var o;
      C(i) ? D(i, function (t, e) {
        o = Array.isArray(i) && !C(e) ? "" : t, s(n + "[" + o + "]", e)
      }) : (o = null == i || "" === i ? "=" : "=" + encodeURIComponent(i), e.push(encodeURIComponent(n) + o))
    }
    return Array.isArray(t) ? D(t, function () {
  ...
  L.fn.trigger = function (t, e) {
    ...
    return (n = s ? new MouseEvent(i.type, o) : (o.detail = e, new CustomEvent(i.type, o)))._detail = e, n._ns = i.ns, this.each(function () {
  ...
  L.ajax = function (t) {
    ...
    function $(t, e, n) {
      for (var i, o, s = [], r = arguments.length - 3; 0 < r--;) s[r] = arguments[r + 3];
      w && L(document).trigger(t, e), n && (n in J && (i = J[n].apply(J, s)), c[n] && (o = c[n].apply(c, s)), "beforeSend" !== n || !1 !== i && !1 !== o || (a = !0))
    }
    return !d || !G(l) && !o || E(d) || d instanceof ArrayBuffer || d instanceof Blob || d instanceof Document || d instanceof FormData || (d = V(d)), d && G(l) && (i = Q(i, d), d = null), new Promise(function (t, e) {
      G(l) && !f && (i = Q(i, "_=" + Date.now()));
      var o, s = new XMLHttpRequest;
      s.open(l, i, h, p, m), (x || d && !G(l) && !1 !== x) && s.setRequestHeader("Content-Type", x), "json" === b && s.setRequestHeader("Accept", "application/json, text/javascript"), v && D(v, function (t, e) {
        O(e) || s.setRequestHeader(t, e + "")
      }), /^([\w-]+:)?\/\/([^/]+)/.test(i) && RegExp.$2 !== window.location.host || s.setRequestHeader("X-Requested-With", "XMLHttpRequest"), g && D(g, function (t, e) {
        s[t] = e
      }), u.xhr = s, u.options = c, s.onload = function () {
        o && clearTimeout(o);
        var n, i = 200 <= s.status && s.status < 300 || 304 === s.status || 0 === s.status;
        if (i)
          if (r = 204 === s.status || "HEAD" === l ? "nocontent" : 304 === s.status ? "notmodified" : "success", "json" === b) {
            try {
              n = "HEAD" === l ? void 0 : JSON.parse(s.responseText), u.data = n
            } catch (t) {
              $(K.ajaxError, u, "error", s, r = "parsererror"), e(new Error(r))
            }
            "parsererror" !== r && ($(K.ajaxSuccess, u, "success", n, r, s), t(n))
          } else n = "HEAD" === l ? void 0 : "text" === s.responseType || "" === s.responseType ? s.responseText : s.response, u.data = n, $(K.ajaxSuccess, u, "success", n, r, s), t(n);
        ...
        o && clearTimeout(o), $(K.ajaxError, u, "error", s, s.statusText), $(K.ajaxComplete, u, "complete", s, "error"), e(new Error(s.statusText))
      }, s.onabort = function () {
        var t = "abort";
        o && (t = "timeout", clearTimeout(o)), $(K.ajaxError, u, "error", s, t), $(K.ajaxComplete, u, "complete", s, t), e(new Error(t))
      }, $(K.ajaxStart, u, "beforeSend", s), a ? e(new Error("cancel")) : (0 < C && (o = setTimeout(function () {
        s.abort()
      }, C)), s.send(d))
    })
  ...
  function et(t, e, n) {
    var i;
    return C(e) ? (tt(t, e), e) : O(n) ? O(e) ? t[Z] ? t[Z] : {} : (e = $(e), t[Z] && e in t[Z] ? t[Z][e] : void 0) : (tt(t, ((i = {})[e] = n, i)), n)
  }
  ...
  function it(e, t) {
    if (e[Z]) {
      ...
      O(t) ? (e[Z] = null, delete e[Z]) : E(t) ? t.split(" ").filter(function (t) {
        return t
      }).forEach(function (t) {
        return n(t)
      }) : D(t, function (t, e) {
  ...
  L.data = et, L.each = D, L.extend = function () {
    for (var n = this, t = [], e = arguments.length; e--;) t[e] = arguments[e];
    return 1 === t.length ? (D(t[0], function (t, e) {
      n[t] = e
    }), this) : X.apply(void 0, [t.shift(), t.shift()].concat(t))
  }, L.map = nt, L.merge = N, L.param = V, L.removeData = it, L.unique = ot, L.fn.add = function (t) {
    ...
    L.fn[i + "Class"] = function (e) {
      return "remove" !== i || arguments.length ? this.each(function (t, n) {
        b(n) && D((p(e) ? e.call(n, t, n.getAttribute("class") || "") : e).split(" ").filter(function (t) {
          return t
        }), function (t, e) {
          n.classList[i](e)
        })
    ...
    L.fn[t] = function () {
      ...
      return 1 === s && (t = t.reverse()), this.each(function (i, o) {
        D(p(t[0]) ? [t[0].call(o, i, o.innerHTML)] : t, function (t, e) {
          var n;
          (!E(n = e) || "<" === n[0] && ">" === n[n.length - 1] ? i && b(e) ? L(e.cloneNode(!0)) : L(e) : L(j(e, "div")))[s ? "insertAfter" : "insertBefore"](o)
        })
      })
    }
  }), L.fn.off = function (t, n, e) {
    var i = this;
    return C(t) ? (D(t, function (t, e) {
      i.off(t, n, e)
    }), this) : (!1 !== n && !p(n) || (e = n, n = void 0), !1 === e && (e = M), this.each(function () {
      U(this, t, e, n)
    }))
  }, L.fn.on = function (t, n, i, e, o) {
    var s = this;
    if (C(t)) return E(n) || (i = i || n, n = void 0), D(t, function (t, e) {
      s.on(t, n, i, e, o)
    }), this;
    if (null == i && null == e ? (e = n, i = n = void 0) : null == e && (E(n) ? (e = i, i = void 0) : (e = i, i = n, n = void 0)), !1 === e) e = M;
    ...
    return this.each(function () {
      ! function (s, t, r, a, u) {
        ...
        z[c] || (z[c] = []);
        var l = !1;
        C(a) && a.useCapture && (l = !0), t.split(" ").forEach(function (t) {
          if (t) {
            var n = W(t),
              e = {
                type: n.type,
          ...
          function i(t, e) {
            !1 === r.apply(e, void 0 === t._detail ? [t] : [t].concat(t._detail)) && (t.preventDefault(), t.stopPropagation())
          }

          function o(e) {
            e._ns && !Y(e._ns).test(n.ns) || (e._data = a, u ? L(s).find(u).get().reverse().forEach(function (t) {
    ...
    return new R(nt(this, function (t, e) {
      return n.call(t, e, t)
    }))
  }, L.fn.clone = function () {
    ...
    var i = !1;
    if (p(n)) return this.each(function (t, e) {
      n.call(e, t, e) && (i = !0)
    }), i;
    if (E(n)) return this.each(function (t, e) {
      y(e) || g(e) || (e.matches || e.msMatchesSelector).call(e, n) && (i = !0)
    }), i;
    var e = L(n);
    ...
    L.fn[t] = function () {
      ...
      return this.each(function (t, e) {
        ...
        })), (n = L(s))[u ? "after" : "before"].apply(n, r), o || e.removeChild(s)
      })
    }
    ...
    L.fn[r] = function (n, i) {
      var o = this;
      if (C(n)) return D(n, function (t, e) {
        o[r](t, e)
      }), this;
      if (1 !== arguments.length) return this.each(function (t, e) {
        ! function (t, e, n) {
          if (!O(n)) switch (s) {
            case 0:
            ...
            case 1:
              ...
              break;
            default:
              e = $(e), t.style[e] = m(n) ? n + (-1 < A.indexOf(e) ? "" : "px") : n
          }
  ...
  function at(t, e, n) {
    if (O(n) && 1 === t.nodeType) {
      var i = "data-" + k(e);
      if (E(n = t.getAttribute(i))) try {
        n = "true" === (o = n) || "false" !== o && ("null" === o ? null : o === +o + "" ? +o : rt.test(o) ? JSON.parse(o) : o)
      } catch (t) {} else n = void 0
    }
    var o;
    return n
  }
  ...
  function ut(e, n, t, i, o, s) {
    ...
    return 2 === i && o && (t += r("margin")), T(e) ? (window.document.documentMode && 1 === s && (t += r("border"), t += r("padding")), 0 === i && (t -= r("border")), 1 === i && (t -= r("border"), t -= r("padding"))) : (0 === i && (t += r("padding")), 2 === i && (t += r("border"), t += r("padding"))), t
  }
  ...
  L.fn.data = function (t, e) {
    ...
    return C(t) ? this.each(function () {
      et(this, t)
    }) : 2 === arguments.length && O(e) ? this : O(e) ? this.length ? at(this[0], t, et(this[0], t)) : void 0 : this.each(function () {
      et(this, t, e)
    })
  }, L.fn.empty = function () {
    return this.each(function () {
    ...
    if (p(n)) return this.map(function (t, e) {
      return n.call(e, t, e) ? e : void 0
    });
    if (E(n)) return this.map(function (t, e) {
          ...
          return function (t, e, n, i, o, s) {
            ...
            if (null != r) {
              ...
              if (-1 < ["auto", "inherit", ""].indexOf(r)) a.css(u, r);
                ...
                r = ut(t, n, parseFloat(r), i, o, -1) + (c || "px"), a.css(u, r)
              }
            }
          }(e, t, s, o, i, n)
        }) : this.length ? ct(this[0], s, o, i) : void 0
      }
    })
  }), L.fn.hide = function () {
    return this.each(function () {
    ...
    function r(t) {
      if (2 === o) return nt(t, function (t) {
        return w(t)[s]
      }).join("");
      if (t.length) {
        var e = t[0];
        return 0 === o && L(e).is("select[multiple]") ? nt(L(e).find("option:checked"), function (t) {
          return t.value
        }) : e[s]
      }
    }
    L.fn[t] = function (i) {
      return arguments.length ? this.each(function (t, e) {
        ...
        0 === o && Array.isArray(n) ? L(e).is("select[multiple]") ? nt(L(e).find("option"), function (t) {
    ...
    return arguments.length ? E(t) ? L(t).get().indexOf(this[0]) : this.get().indexOf(L(t)[0]) : this.eq(0).parent().children().get().indexOf(this[0])
  }, L.fn.last = function () {
    return this.eq(-1)
    ...
    return this.map(function () {
      for (var t = this.offsetParent; t && "static" === L(t).css("position");) t = t.offsetParent;
    ...
    if (this.length) {
      ...
      if ("fixed" === e.css("position")) t = e[0].getBoundingClientRect();
        ...
        (n = i.offset()).top += lt(i, "border-top-width"), n.left += lt(i, "border-left-width")
      }
      return {
    ...
    }) : this.length ? dt(this[0]) : void 0
  }, L.fn.one = function (t, e, n, i) {
    return this.on(t, e, n, i, !0)
  }, D(["", "All", "Until"], function (n, t) {
    L.fn["prev" + t] = function (t, e) {
      return st(n ? L(this.get().reverse()) : this, n, "previousElementSibling", t, e)
    }
    ...
    return this.each(function (t, e) {
      var n = i;
      p(n) ? n = n.call(e, t, e.innerHTML) : t && !E(n) && (n = L(n).clone()), L(e).before(n)
    }), this.remove()
  ...
  L.fn.show = function () {
    return this.each(function () {
      var t, e, n;
      "none" === this.style.display && (this.style.display = ""), "none" === S(this, "display") && (this.style.display = (t = this.nodeName, ht[t] || (e = document.createElement(t), document.body.appendChild(e), n = S(e, "display"), e.parentNode.removeChild(e), "none" === n && (n = "block"), ht[t] = n), ht[t]))
    })
    ...
    return m(t) && (t += "ms"), this.each(function () {
    ...
    function o(t) {
      t.target === this && (e.call(this, t), D(i, function (t, e) {
        n.off(e, o)
      }))
    }
  ...
  function pt(t, e, n, i) {
    ...
    o || et(i, "_mdui_mutation", o = []), -1 === o.indexOf(t) && (o.push(t), e.call(i, n, i))
  }
  L.fn.mutation = function () {
    return this.each(function (t, e) {
      var o = L(e);
      D(ft, function (n, i) {
        o.is(n) && pt(n, i, t, e), o.find(n).each(function (t, e) {
          pt(n, i, t, e)
        })
      })
    })
    ...
    e.length ? (e.data("_overlay_is_deleted", !1), O(t) || e.css("z-index", t)) : (O(t) && (t = 2e3), e = L('<div class="mdui-overlay">').appendTo(document.body).reflow().css("z-index", t));
    ...
    1 < n ? e.data("_lockscreen_level", --n) : e.data("_lockscreen_level", 0).removeClass("mdui-locked").width("")
  }, L.throttle = function (i, o) {
    void 0 === o && (o = 16);
    var s = null;
    return function () {
      for (var t = this, e = [], n = arguments.length; n--;) e[n] = arguments[n];
      v(s) && (s = setTimeout(function () {
        i.apply(t, e), s = null
      }, o))
    }
  };
  ...
  L.guid = function (t) {
    ...
    O(n) || O(i) ? L(document).mutation() : (ft[n] = i, L(n).each(function (t, e) {
      return pt(n, i, t, e)
    }))
  };

  function gt(t, e) {
    void 0 === e && (e = {}), this.options = X({}, xt), this.state = "pinned", this.isEnable = !1, this.lastScrollY = 0, this.rafId = 0, this.$element = L(t).first(), X(this.options, e);
    var n = this.options.tolerance;
    m(n) && (this.options.tolerance = {
      down: n,
      up: n
    }), this.enable()
  }
  ...
  gt.prototype.onScroll = function () {
  ...
  }, gt.prototype.triggerEvent = function (t) {
    vt(t, "headroom", this.$element, this)
  }, gt.prototype.transitionEnd = function () {
    ...
    var t = this;
    this.isEnable || (this.isEnable = !0, this.state = "pinned", this.$element.addClass(this.options.initialClass).removeClass(this.options.pinnedClass).removeClass(this.options.unpinnedClass), this.lastScrollY = window.pageYOffset, bt.on("scroll", function () {
      return t.onScroll()
    }))
  }, gt.prototype.disable = function () {
    var t = this;
    this.isEnable && (this.isEnable = !1, this.$element.removeClass(this.options.initialClass).removeClass(this.options.pinnedClass).removeClass(this.options.unpinnedClass), bt.off("scroll", function () {
      return t.onScroll()
    }), window.cancelAnimationFrame(this.rafId))
  }, gt.prototype.getState = function () {
    return this.state
  }, B.Headroom = gt;
  ...
  function $t(t, e) {
    ...
    this.classItem = n, this.classItemOpen = n + "-open", this.classHeader = n + "-header", this.classBody = n + "-body", this.$element = L(t).first(), X(this.options, e), this.bindEvent()
  }
  var Et = {
    accordion: !1
  };
  $t.prototype.bindEvent = function () {
    ...
    this.$element.on("click", "." + this.classHeader, function () {
      ...
      var t = L(this).parents("." + i.classItem).first();
      i.close(t)
    })
    ...
    this.isOpen(e) ? (t.transition(0).height("auto").reflow().transition(""), this.triggerEvent("opened", e)) : (t.height(""), this.triggerEvent("closed", e))
    ...
    if (!this.isOpen(o)) {
      ...
      }), this.triggerEvent("open", o), o.addClass(this.classItemOpen)
    }
    ...
    if (this.isOpen(n)) {
      ...
      this.triggerEvent("close", n), n.removeClass(this.classItemOpen), i.transition(0).height(i[0].scrollHeight).reflow().transition("").height("").transitionEnd(function () {
  ...
  var Ot = function (t) {
    ...
    return t && (e.__proto__ = t), ((e.prototype = Object.create(t && t.prototype)).constructor = e).prototype.getNamespace = function () {
      return "collapse"
    }, e
  }($t);
  B.Collapse = Ot;
  ...
  function It(t) {
    this.$thRow = L(), this.$tdRows = L(), this.$thCheckbox = L(), this.$tdCheckboxs = L(), this.selectable = !1, this.selectedRow = 0, this.$element = L(t).first(), this.init()
  }
  It.prototype.init = function () {
    ...
    this.$tdRows.each(function (t, e) {
      ...
      if (n.find(".mdui-table-cell-checkbox").remove(), o.selectable) {
        var i = L(o.createCheckboxHTML("td")).prependTo(n).find('input[type="checkbox"]');
        n.hasClass(s) && (i[0].checked = !0, o.selectedRow++), o.updateThCheckboxStatus(), i.on("change", function () {
          i[0].checked ? (n.addClass(s), o.selectedRow++) : (n.removeClass(s), o.selectedRow--), o.updateThCheckboxStatus()
        }), o.$tdCheckboxs = o.$tdCheckboxs.add(i)
      }
    })
  }, It.prototype.updateThCheckbox = function () {
    var t = this;
    this.$thRow.find(".mdui-table-cell-checkbox").remove(), this.selectable && (this.$thCheckbox = L(this.createCheckboxHTML("th")).prependTo(this.$thRow).find('input[type="checkbox"]').on("change", function () {
      var n = t.$thCheckbox[0].checked;
      t.selectedRow = n ? t.$tdRows.length : 0, t.$tdCheckboxs.each(function (t, e) {
        e.checked = n
      }), t.$tdRows.each(function (t, e) {
        n ? L(e).addClass("mdui-table-row-selected") : L(e).removeClass("mdui-table-row-selected")
      })
    }))
  ...
  function Pt(t, e) {
    if (!(t instanceof MouseEvent && 2 === t.button)) {
      ...
      L('<div class="mdui-ripple-wave" style="width:' + l + "px;height:" + l + "px;margin-top:-" + l / 2 + "px;margin-left:-" + l / 2 + "px;left:" + u + "px;top:" + c + 'px;"></div>').data("_ripple_wave_translate", d).prependTo(e).reflow().transform(d)
    }
  }
      ...
      if (n.length && !n.prop("disabled") && O(n.attr("disabled")))
        if ("touchstart" === t.type) {
          var i = !1,
            ...
            s = function () {
              o && (clearTimeout(o), o = 0, Pt(t, n)), i || (i = !0, Nt.call(n))
            };
  ...
  function qt(t, e) {
    ...
    if (!(-1 < ["checkbox", "button", "submit", "range", "radio", "image"].indexOf(r))) {
      ...
      if ("focus" === o && a.addClass("mdui-textfield-focus"), "blur" === o && a.removeClass("mdui-textfield-focus"), "blur" !== o && "input" !== o || (s ? a.addClass("mdui-textfield-not-empty") : a.removeClass("mdui-textfield-not-empty")), n.disabled ? a.addClass("mdui-textfield-disabled") : a.removeClass("mdui-textfield-disabled"), "input" !== o && "blur" !== o || e.domLoadedEvent || !n.validity || (n.validity.valid ? a.removeClass("mdui-textfield-invalid-html5") : a.addClass("mdui-textfield-invalid-html5")), i.is("textarea")) {
        var u = s,
          c = !1;
        "" === u.replace(/[\r\n]/g, "") && (i.val(" " + u), c = !0), i.outerHeight("");
        var l = i.outerHeight(),
          d = n.scrollHeight;
      ...
      h && ((e.reInit || e.domLoadedEvent) && L('<div class="mdui-textfield-counter"><span class="mdui-textfield-counter-inputed"></span> / ' + h + "</div>").appendTo(a), a.find(".mdui-textfield-counter-inputed").text(s.length.toString())), (a.find(".mdui-textfield-helper").length || a.find(".mdui-textfield-error").length || h) && a.addClass("mdui-textfield-has-bottom")
    }
  }
  ...
  function Wt(t) {
    var e = t.data(),
      ...
      d = s.val(),
      h = (d - r) / (a - r) * 100;
    i.width(h + "%"), n.width(100 - h + "%"), u && (i.css("padding-right", "6px"), n.css("padding-left", "6px")), o.css("left", h + "%"), c && l.text(d), 0 == h ? t.addClass("mdui-slider-zero") : t.removeClass("mdui-slider-zero")
  }
  ...
  function Yt(t) {
    ...
    s ? t.addClass("mdui-slider-disabled") : t.removeClass("mdui-slider-disabled"), t.find(".mdui-slider-track").remove(), t.find(".mdui-slider-fill").remove(), t.find(".mdui-slider-thumb").remove(), t.append(e).append(n).append(i);
    var a = L();
    r && (a = L("<span></span>"), i.empty().append(a)), t.data("_slider_$track", e), t.data("_slider_$fill", n), t.data("_slider_$thumb", i), t.data("_slider_$input", o), t.data("_slider_min", o.attr("min")), t.data("_slider_max", o.attr("max")), t.data("_slider_disabled", s), t.data("_slider_discrete", r), t.data("_slider_$thumbText", a), Wt(t)
  }
  L(function () {
    yt.on("input focus blur", ".mdui-textfield-input", {
      useCapture: !0
    }, qt), yt.on("click", ".mdui-textfield-expandable .mdui-textfield-icon", function () {
      L(this).parents(".mdui-textfield").addClass("mdui-textfield-expanded").find(".mdui-textfield-input")[0].focus()
    }), yt.on("click", ".mdui-textfield-expanded .mdui-textfield-close", function () {
      L(this).parents(".mdui-textfield").removeClass("mdui-textfield-expanded").find(".mdui-textfield-input").val("")
    }), B.mutation(".mdui-textfield", function () {
      L(this).find(".mdui-textfield-input").trigger("input", {
        domLoadedEvent: !0
      })
    })
  }), B.updateTextFields = function (t) {
    (O(t) ? L(".mdui-textfield") : L(t)).each(function (t, e) {
      L(e).find(".mdui-textfield-input").trigger("input", {
        reInit: !0
      })
    })
  };
  ...
  L(function () {
    yt.on("input change", Ut, function () {
      Wt(L(this).parent())
    }), yt.on(jt, Ut, function (t) {
      Lt(t) && (Bt(t), this.disabled || L(this).parent().addClass("mdui-slider-focus"))
    }), yt.on(At, Ut, function (t) {
      Lt(t) && (this.disabled || L(this).parent().removeClass("mdui-slider-focus"))
    }), yt.on(Rt, Ut, Bt), B.mutation(".mdui-slider", function () {
      Yt(L(this))
    })
  ...
  function Xt(t, e) {
    var n = this;
    void 0 === e && (e = {}), this.options = X({}, Vt), this.state = "closed", this.$element = L(t).first(), X(this.options, e), this.$btn = this.$element.find(".mdui-fab"), this.$dial = this.$element.find(".mdui-fab-dial"), this.$dialBtns = this.$dial.find(".mdui-fab"), "hover" === this.options.trigger && (this.$btn.on("touchstart mouseenter", function () {
      return n.open()
  ...
  Xt.prototype.triggerEvent = function (t) {
    ...
    }), this.$dial.css("height", "auto").addClass("mdui-fab-dial-show"), this.$btn.find(".mdui-fab-opened").length && this.$btn.addClass("mdui-fab-opened"), this.state = "opening", this.triggerEvent("open"), this.$dialBtns.first().transitionEnd(function () {
      i.$btn.hasClass("mdui-fab-opened") && (i.state = "opened", i.triggerEvent("opened"))
    }))
    ...
    this.isOpen() && (this.$dialBtns.each(function (t, e) {
      var n = 15 * t + "ms";
      e.style.transitionDelay = n, e.style.webkitTransitionDelay = n
    }), this.$dial.removeClass("mdui-fab-dial-show"), this.$btn.removeClass("mdui-fab-opened"), this.state = "closing", this.triggerEvent("close"), this.$dialBtns.last().transitionEnd(function () {
      t.$btn.hasClass("mdui-fab-opened") || (t.state = "closed", t.triggerEvent("closed"), t.$dial.css("height", 0))
    }))
  ...
  var Jt = "mdui-fab";
  L(function () {
    yt.on("touchstart mousedown mouseover", "[" + Jt + "]", function () {
  ...
  function Kt(t, e) {
    var n = this;
    void 0 === e && (e = {}), this.$element = L(), this.options = X({}, Gt), this.size = 0, this.$selected = L(), this.$menu = L(), this.$items = L(), this.selectedIndex = 0, this.selectedText = "", this.selectedValue = "", this.state = "closed", this.$native = L(t).first(), this.$native.hide(), X(this.options, e), this.uniqueID = L.guid(), this.handleUpdate(), yt.on("click touchstart", function (t) {
      var e = L(t.target);
  ...
  Kt.prototype.readjustMenu = function () {
    ...
    if ("bottom" === this.options.position) e = i, t = "0px";
      ...
      e < d && (e = d);
      var h = c + e;
      h < this.options.gutter ? e = -(c - this.options.gutter) : h + u + this.options.gutter > n && (e = -(c + u + this.options.gutter - n)), t = this.selectedIndex * s + s / 2 + r + "px"
    }
    this.$element.innerWidth(a), this.$menu.innerWidth(a).height(u).css({
      "margin-top": e + "px",
    ...
    var a = [];
    this.$items = L(), this.$native.find("option").each(function (t, e) {
      var n = e.textContent || "",
        i = e.value,
        o = e.disabled,
        s = r.selectedValue === i;
      a.push({
        ...
        selected: s,
        index: t
      }), s && (r.selectedText = n, r.selectedIndex = t), r.$items = r.$items.add('<div class="mdui-select-menu-item mdui-ripple"' + (o ? " disabled" : "") + (s ? " selected" : "") + ">" + n + "</div>")
    }), this.$selected = L('<span class="mdui-select-selected">' + this.selectedText + "</span>"), this.$element = L('<div class="mdui-select mdui-select-position-' + this.options.position + '" style="' + this.$native.attr("style") + '" id="' + this.uniqueID + '"></div>').show().append(this.$selected), this.$menu = L('<div class="mdui-select-menu"></div>').appendTo(this.$element).append(this.$items), L("#" + this.uniqueID).remove(), this.$native.after(this.$element), this.size = parseInt(this.$native.attr("size") || "0"), this.size <= 0 && (this.size = this.$items.length, 8 < this.size && (this.size = 8));
    var i = this;
    this.$items.on("click", function () {
      if ("closing" !== i.state) {
        var t = L(this),
          e = t.index(),
          n = a[e];
        n.disabled || (i.$selected.text(n.text), i.$native.val(n.value), i.$items.removeAttr("selected"), t.attr("selected", ""), i.selectedIndex = n.index, i.selectedValue = n.value, i.selectedText = n.text, i.$native.trigger("change"), i.close())
      }
    ...
    this.$element.removeClass("mdui-select-closing"), "opening" === this.state && (this.state = "opened", this.triggerEvent("opened"), this.$menu.css("overflow-y", "auto")), "closing" === this.state && (this.state = "closed", this.triggerEvent("closed"), this.$element.innerWidth(""), this.$menu.css({
      "margin-top": "",
      height: "",
      width: ""
    }))
    ...
    var t = this;
    this.isOpen() || (this.state = "opening", this.triggerEvent("open"), this.readjustMenu(), this.$element.addClass("mdui-select-open"), this.$menu.transitionEnd(function () {
      return t.transitionEnd()
    }))
  }, Kt.prototype.close = function () {
    var t = this;
    this.isOpen() && (this.state = "closing", this.triggerEvent("close"), this.$menu.css("overflow-y", ""), this.$element.removeClass("mdui-select-open").addClass("mdui-select-closing"), this.$menu.transitionEnd(function () {
      return t.transitionEnd()
    }))
  ...
  function Zt(t, e) {
    var n = this;
    void 0 === e && (e = {}), this.options = X({}, te), this.activeIndex = -1, this.$element = L(t).first(), X(this.options, e), this.$tabs = this.$element.children("a"), this.$indicator = L('<div class="mdui-tab-indicator"></div>').appendTo(this.$element);
    ...
    }), this.$tabs.length && -1 === this.activeIndex && (this.activeIndex = 0), this.setActive(), bt.on("resize", L.throttle(function () {
      return n.setIndicatorPosition()
    }, 100)), this.$tabs.each(function (t, e) {
      n.bindTabEvent(e)
    })
  }
  var te = {
  ...
  Zt.prototype.isDisabled = function (t) {
    ...
    var n = this,
      i = L(t);
    i.on("click", e), "hover" === this.options.trigger && i.on("mouseenter", e), i.on("click", function () {
    ...
    this.$tabs.each(function (t, e) {
      var n = L(e),
        i = n.attr("href") || "";
      t !== o.activeIndex || o.isDisabled(n) ? (n.removeClass("mdui-tab-active"), L(i).hide()) : (n.hasClass("mdui-tab-active") || (o.triggerEvent("change", o.$element, {
        index: o.activeIndex,
        id: i.substr(1)
      }), o.triggerEvent("show", n), n.addClass("mdui-tab-active")), L(i).show(), o.setIndicatorPosition())
    })
    ...
    -1 !== this.activeIndex && (0 < this.activeIndex ? this.activeIndex-- : this.options.loop && (this.activeIndex = this.$tabs.length - 1), this.setActive())
  }, Zt.prototype.show = function (n) {
    var i = this; - 1 !== this.activeIndex && (m(n) ? this.activeIndex = n : this.$tabs.each(function (t, e) {
      if (e.id === n) return i.activeIndex, !1
    }), this.setActive())
    ...
    var n = this,
      ...
      i = t.get(),
      o = e.get();
    if (!e.length) return this.activeIndex = -1, this.$tabs = e, void this.setIndicatorPosition();
    e.each(function (t, e) {
      i.indexOf(e) < 0 && (n.bindTabEvent(e), -1 === n.activeIndex ? n.activeIndex = 0 : t <= n.activeIndex && n.activeIndex++)
    }), t.each(function (t, e) {
      o.indexOf(e) < 0 && (t < n.activeIndex ? n.activeIndex-- : t === n.activeIndex && (n.activeIndex = 0))
    }), this.$tabs = e, this.setActive()
  }, B.Tab = Zt;
  var ee = "mdui-tab";
  L(function () {
  ...
  function ne(t, e) {
    var n = this;
    void 0 === e && (e = {}), this.options = X({}, ie), this.overlay = !1, this.$element = L(t).first(), X(this.options, e), this.position = this.$element.hasClass("mdui-drawer-right") ? "right" : "left", this.$element.hasClass("mdui-drawer-close") ? this.state = "closed" : this.$element.hasClass("mdui-drawer-open") || this.isDesktop() ? this.state = "opened" : this.state = "closed", bt.on("resize", L.throttle(function () {
      n.isDesktop() ? (n.overlay && !n.options.overlay && (L.hideOverlay(), n.overlay = !1, L.unlockScreen()), n.$element.hasClass("mdui-drawer-close") || (n.state = "opened")) : n.overlay || "opened" !== n.state || (n.$element.hasClass("mdui-drawer-open") ? (L.showOverlay(), n.overlay = !0, L.lockScreen(), L(".mdui-overlay").one("click", function () {
        return n.close()
      })) : n.state = "closed")
    }, 100)), this.$element.find("[mdui-drawer-close]").each(function (t, e) {
  ...
  ne.prototype.isDesktop = function () {
    ...
    function o() {
      u.$element[0].style.transform = "", u.$element[0].style.webkitTransform = "", u.$element[0].style.transition = "", u.$element[0].style.webkitTransition = ""
    }
    ...
    function p(t) {
      return Math.min(Math.max("closing" === c ? a - t : f() + a - t, 0), f())
    }
    ...
    function m(t) {
      if (c) {
        ...
        l = !1;
        var i = c;
        c = null, "opening" === i ? n < .92 ? (o(), u.open()) : o() : .08 < n ? (o(), u.close()) : o(), L.unlockScreen()
      } else l = !1;
      d.off({
        touchmove: v,
        touchend: m,
    ...
    function v(t) {
      ...
      if (c) h(p(e));
        ...
        var i = Math.abs(e - s),
          o = Math.abs(n - r);
        8 < i && o <= 8 ? (a = e, c = "opened" === u.state ? "closing" : "opening", L.lockScreen(), h(p(e))) : i <= 8 && 8 < o && m()
      }
    }

    function i(t) {
      s = t.touches[0].pageX, "right" === u.position && (s = d.width() - s), r = t.touches[0].pageY, "opened" !== u.state && (n < s || e !== i) || (l = !0, d.on({
        touchmove: v,
        touchend: m,
        touchcancel: v
      }))
    ...
    var t = this;
    this.isOpen() || (this.state = "opening", this.triggerEvent("open"), this.options.overlay || L("body").addClass("mdui-drawer-body-" + this.position), this.$element.removeClass("mdui-drawer-close").addClass("mdui-drawer-open").transitionEnd(function () {
      return t.transitionEnd()
    }), this.isDesktop() && !this.options.overlay || (this.overlay = !0, L.showOverlay().one("click", function () {
      return t.close()
    }), L.lockScreen()))
  }, ne.prototype.close = function () {
    var t = this;
    this.isOpen() && (this.state = "closing", this.triggerEvent("close"), this.options.overlay || L("body").removeClass("mdui-drawer-body-" + this.position), this.$element.addClass("mdui-drawer-close").removeClass("mdui-drawer-open").transitionEnd(function () {
      return t.transitionEnd()
    }), this.overlay && (L.hideOverlay(), this.overlay = !1, L.unlockScreen()))
  ...
  function ue(t, e) {
    var n = this;
    void 0 === e && (e = {}), this.options = X({}, le), this.state = "closed", this.append = !1, this.$element = L(t).first(), P(document.body, this.$element[0]) || (this.append = !0, L("body").append(this.$element)), X(this.options, e), this.$element.find("[mdui-dialog-cancel]").each(function (t, e) {
      L(e).on("click", function () {
  ...
  ue.prototype.triggerEvent = function (t) {
    ...
    this.$element.hasClass("mdui-dialog-open") ? (this.state = "opened", this.triggerEvent("opened")) : (this.state = "closed", this.triggerEvent("closed"), this.$element.hide(), re(he).length || de || !fe || (L.unlockScreen(), fe = !1), bt.off("resize", L.throttle(this.readjust, 100)), this.options.destroyOnClosed && this.destroy())
  }, ue.prototype.doOpen = function () {
    var t = this;
    if (de = this, fe || (L.lockScreen(), fe = !0), this.$element.show(), this.readjust(), bt.on("resize", L.throttle(this.readjust, 100)), this.state = "opening", this.triggerEvent("open"), this.$element.addClass("mdui-dialog-open").transitionEnd(function () {
        return t.transitionEnd()
      }), ce = ce || L.showOverlay(5100), this.options.modal ? ce.off("click", this.overlayClick) : ce.on("click", this.overlayClick), ce.css("opacity", this.options.overlay ? "" : 0), this.options.history) {
      var e = window.location.hash.substring(1); - 1 < e.indexOf("mdui-dialog") && (e = e.replace(/[&?]?mdui-dialog/g, "")), window.location.hash = e ? e + (-1 < e.indexOf("?") ? "&" : "?") + "mdui-dialog" : "mdui-dialog", bt.on("hashchange", this.hashchangeEvent)
    }
    ...
    var e = this;
    void 0 === t && (t = !1), setTimeout(function () {
      e.isOpen() && (de = null, e.state = "closing", e.triggerEvent("close"), !re(he).length && ce && (L.hideOverlay(), ce = null, L(".mdui-overlay").css("z-index", 2e3)), e.$element.removeClass("mdui-dialog-open").transitionEnd(function () {
        return e.transitionEnd()
      }), e.options.history && !re(he).length && (t || window.history.back(), bt.off("hashchange", e.hashchangeEvent)), setTimeout(function () {
        ae(he)
      }, 100))
    })
    ...
    this.append && this.$element.remove(), re(he).length || de || (ce && (L.hideOverlay(), ce = null), fe && (L.unlockScreen(), fe = !1))
  ...
  var ve = {
    ...
    ye = {
      ...
      modal: !(B.dialog = function (n) {
        ...
        var i = "";
        null !== (t = n.buttons) && void 0 !== t && t.length && (i = '<div class="mdui-dialog-actions' + (n.stackedButtons ? " mdui-dialog-actions-stacked" : "") + '">', D(n.buttons, function (t, e) {
    ...
    be = {
      ...
      modal: !(B.alert = function (t, e, n, i) {
        return p(e) && (i = n, n = e, e = ""), O(n) && (n = function () {}), O(i) && (i = {}), i = X({}, ye, i), B.dialog({
          title: e,
          content: t,
          buttons: [{
            text: i.confirmText,
    ...
    xe = {
      ...
      modal: !(B.confirm = function (t, e, n, i, o) {
        return p(e) && (o = i, i = n, n = e, e = ""), O(n) && (n = function () {}), O(i) && (i = function () {}), O(o) && (o = {}), o = X({}, be, o), B.dialog({
          title: e,
          content: t,
          buttons: [{
            text: o.cancelText,
  ...
  B.prompt = function (t, e, i, n, o) {
    p(e) && (o = n, n = i, i = e, e = ""), O(i) && (i = function () {}), O(n) && (n = function () {}), O(o) && (o = {});
    var s = '<div class="mdui-textfield">' + (t ? '<label class="mdui-textfield-label">' + t + "</label>" : "") + ("text" === (o = X({}, xe, o)).type ? '<input class="mdui-textfield-input" type="text" value="' + o.defaultValue + '" ' + (o.maxlength ? 'maxlength="' + o.maxlength + '"' : "") + "/>" : "") + ("textarea" === o.type ? '<textarea class="mdui-textfield-input" ' + (o.maxlength ? 'maxlength="' + o.maxlength + '"' : "") + ">" + o.defaultValue + "</textarea>" : "") + "</div>";
    return B.dialog({
      title: e,
      content: s,
      buttons: [{
      ...
      onOpen: function (n) {
        ...
        B.updateTextFields(t), t[0].focus(), "textarea" !== o.type && !0 === o.confirmOnEnter && t.on("keydown", function (t) {
          if (13 === t.keyCode) {
  ...
  function Ce(t, e) {
    void 0 === e && (e = {}), this.options = X({}, we), this.state = "closed", this.timeoutId = null, this.$target = L(t).first(), X(this.options, e), this.$element = L('<div class="mdui-tooltip" id="' + L.guid() + '">' + this.options.content + "</div>").appendTo(document.body);
    var n = this;
  ...
  Ce.prototype.isDisabled = function (t) {
    ...
    var t, e, n = this.$target[0].getBoundingClientRect(),
      i = this.isDesktop() ? 14 : 24,
      o = this.$element[0].offsetWidth,
      s = this.$element[0].offsetHeight,
      r = this.options.position;
    switch ("auto" === r && (r = n.top + n.height + i + s + 2 < bt.height() ? "bottom" : i + s + 2 < n.top ? "top" : i + o + 2 < n.left ? "left" : n.width + i + o + 2 < bt.width() - n.left ? "right" : "bottom"), r) {
      case "bottom":
        t = o / 2 * -1, e = n.height / 2 + i, this.$element.transformOrigin("top center");
        break;
      case "top":
        t = o / 2 * -1, e = -1 * (s + n.height / 2 + i), this.$element.transformOrigin("bottom center");
        break;
      case "left":
        t = -1 * (o + n.width / 2 + i), e = s / 2 * -1, this.$element.transformOrigin("center right");
        break;
      case "right":
        t = n.width / 2 + i, e = s / 2 * -1, this.$element.transformOrigin("center left")
    }
    ...
    if (!this.isOpen()) {
      ...
      t && X(this.options, t), n.content !== this.options.content && this.$element.html(this.options.content), this.setPosition(), this.options.delay ? this.timeoutId = setTimeout(function () {
        return e.doOpen()
  ...
  var $e = "mdui-tooltip",
    Ee = "_mdui_tooltip";
  L(function () {
    yt.on("touchstart mouseover", "[" + $e + "]", function () {
      var t = L(this),
        e = t.data(Ee);
  ...
  function Oe(t) {
    this.options = X({}, ke), this.state = "closed", this.timeoutId = null, X(this.options, t);
    var e = "",
      n = "";
    0 === this.options.buttonColor.indexOf("#") || 0 === this.options.buttonColor.indexOf("rgb") ? e = 'style="color:' + this.options.buttonColor + '"' : "" !== this.options.buttonColor && (n = "mdui-text-color-" + this.options.buttonColor), this.$element = L('<div class="mdui-snackbar"><div class="mdui-snackbar-text">' + this.options.message + "</div>" + (this.options.buttonText ? '<a href="javascript:void(0)" class="mdui-snackbar-action mdui-btn mdui-ripple mdui-ripple-white ' + n + '" ' + e + ">" + this.options.buttonText + "</a>" : "") + "</div>").appendTo(document.body), this.setPosition("close"), this.$element.reflow().addClass("mdui-snackbar-" + this.options.position)
  }
  var ke = {
      message: "",
      timeout: 4e3,
  ...
  function Ie(t) {
    return void 0 === t && (t = !1), '<div class="mdui-spinner-layer ' + (t ? "mdui-spinner-layer-" + t : "") + '"><div class="mdui-spinner-circle-clipper mdui-spinner-left"><div class="mdui-spinner-circle"></div></div><div class="mdui-spinner-gap-patch"><div class="mdui-spinner-circle"></div></div><div class="mdui-spinner-circle-clipper mdui-spinner-right"><div class="mdui-spinner-circle"></div></div></div>'
  }
  ...
  Oe.prototype.closeOnOutsideClick = function (t) {
    ...
    var e, n, i = this.$element[0].clientHeight,
      o = this.options.position;
    e = "bottom" === o || "top" === o ? "-50%" : "0", "open" === t ? n = "0" : ("bottom" === o && (n = i), "top" === o && (n = -i), "left-top" !== o && "right-top" !== o || (n = -i - 24), "left-bottom" !== o && "right-bottom" !== o || (n = i + 24)), this.$element.transform("translate(" + e + "," + n + "px")
  }, Oe.prototype.open = function () {
    var e = this;
    "opening" !== this.state && "opened" !== this.state && (_e ? re(Te, function () {
      return e.open()
    }) : ((_e = this).state = "opening", this.options.onOpen(this), this.setPosition("open"), this.$element.transitionEnd(function () {
      "opening" === e.state && (e.state = "opened", e.options.onOpened(e), e.options.buttonText && e.$element.find(".mdui-snackbar-action").on("click", function () {
        ...
        L(t.target).hasClass("mdui-snackbar-action") || e.options.onClick(e)
      }), e.options.closeOnOutsideClick && yt.on(jt, e.closeOnOutsideClick), e.options.timeout && (e.timeoutId = setTimeout(function () {
        return e.close()
      }, e.options.timeout)))
    })))
  }, Oe.prototype.close = function () {
    var t = this;
    "closing" !== this.state && "closed" !== this.state && (this.timeoutId && clearTimeout(this.timeoutId), this.options.closeOnOutsideClick && yt.off(jt, this.closeOnOutsideClick), this.state = "closing", this.options.onClose(this), this.setPosition("close"), this.$element.transitionEnd(function () {
      "closing" === t.state && (_e = null, t.state = "closed", t.options.onClosed(t), t.$element.remove(), ae(Te))
    }))
    ...
    yt.on("click", ".mdui-bottom-nav>a", function () {
      var i = L(this),
        o = i.parent();
      o.children("a").each(function (t, e) {
        var n = i.is(e);
        n && vt("change", "bottomNav", o[0], void 0, {
          index: t
        }), n ? L(e).addClass("mdui-bottom-nav-active") : L(e).removeClass("mdui-bottom-nav-active")
      })
  ...
  function je(t, e, n) {
    var i = this;
    if (void 0 === n && (n = {}), this.options = X({}, Me), this.state = "closed", this.$anchor = L(t).first(), this.$element = L(e).first(), !this.$anchor.parent().is(this.$element.parent())) throw new Error("anchorSelector and menuSelector must be siblings");
    X(this.options, n), this.isCascade = this.$element.hasClass("mdui-menu-cascade"), this.isCovered = "auto" === this.options.covered ? !this.isCascade : this.options.covered, this.$anchor.on("click", function () {
      return i.toggle()
    }), yt.on("click touchstart", function (t) {
      var e = L(t.target);
      !i.isOpen() || e.is(i.$element) || P(i.$element[0], e[0]) || e.is(i.$anchor) || P(i.$anchor[0], e[0]) || i.close()
    });
    var o = this;
    yt.on("click", ".mdui-menu-item", function () {
      var t = L(this);
      t.find(".mdui-menu").length || void 0 !== t.attr("disabled") || o.close()
    }), this.bindSubMenuEvent(), bt.on("resize", L.throttle(function () {
      return i.readjust()
    }, 100))
  }
  var Me = {
  ...
  je.prototype.isOpen = function () {
    ...
    if (n = "auto" === this.options.position ? h + u < y + (c ? v : 0) ? "bottom" : h + u < p + (c ? v : 0) ? "top" : "center" : this.options.position, i = "auto" === this.options.align ? d + u < b + g ? "left" : d + u < m + g ? "right" : "center" : this.options.align, "bottom" === n) s = "0", e = (c ? 0 : v) + (l ? p : x);
    else if ("top" === n) s = "100%", e = (c ? v : 0) + (l ? p - h : x - h);
    else {
      s = "50%";
      var w = h;
      this.isCascade || r < h + 2 * u && (w = r - 2 * u, this.$element.height(w)), e = (r - w) / 2 + (l ? 0 : x - p)
    }
    if (this.$element.css("top", e + "px"), "left" === i) o = "0", t = l ? m : C;
    else if ("right" === i) o = "100%", t = l ? m + g - d : C + g - d;
    else {
      o = "50%";
      var $ = d;
      a < d + 2 * u && ($ = a - 2 * u, this.$element.width($)), t = (a - $) / 2 + (l ? 0 : C - m)
    }
    this.$element.css("left", t + "px"), this.$element.transformOrigin(o + " " + s)
  }, je.prototype.readjustSubmenu = function (t) {
    var e, n, i, o, s, r, a = t.parent(".mdui-menu-item"),
      u = bt.height(),
      c = bt.width(),
      l = t.width(),
      d = t.height(),
      ...
      m = h.left,
      v = h.top;
    o = l < c - m - f ? "left" : l < m ? "right" : "left", "bottom" === (i = d < u - v ? "bottom" : d < v + p ? "top" : "bottom") ? e = r = "0" : "top" === i && (r = "100%", e = -d + p), t.css("top", e + "px"), "left" === o ? (s = "0", n = f) : "right" === o && (s = "100%", n = -l), t.css("left", n + "px"), t.transformOrigin(s + " " + r)
    ...
    }).parent(".mdui-menu-item").removeClass("mdui-menu-item-active"), t.find(".mdui-menu").each(function (t, e) {
      var n = L(e);
        ...
        if (void 0 === e.attr("disabled")) {
          ...
          if ("mouseover" === n) {
            if (o.length) {
              ...
              if (s && clearTimeout(s), o.hasClass("mdui-menu-open")) return;
              clearTimeout(c), u = c = setTimeout(function () {
                return a.openSubMenu(o)
              }, a.options.subMenuDelay), o.data("timeoutOpen.mdui.menu", u)
            }
          } else if ("mouseout" === n && o.length) {
            var r = o.data("timeoutOpen.mdui.menu");
            r && clearTimeout(r), u = setTimeout(function () {
              return a.closeSubMenu(o)
            }, a.options.subMenuDelay), o.data("timeoutClose.mdui.menu", u)
          }
        }
      })
    }
    ...
    var n = this;
    this.isOpen() && (this.state = "closing", this.triggerEvent("close"), this.$element.find(".mdui-menu").each(function (t, e) {
      n.closeSubMenu(L(e))
